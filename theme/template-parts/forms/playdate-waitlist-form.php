...
<div class="max-w-2xl mx-auto bg-white rounded-lg shadow-sm p-6 md:p-8">
    <form id="playdate-waitlist-form" class="space-y-6" method="POST">
        ...
        <div class="pt-4">
            <button type="submit" class="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-[#f59e0b] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#d97706]">
                Join Waitlist
