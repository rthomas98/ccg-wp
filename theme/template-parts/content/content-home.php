...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php
    // Layout225 Component
    if (have_rows('layout_225')) :
        while (have_rows('layout_225')) : the_row();
            $image = get_sub_field('image');
    ?>
        <section id="relume" class="px-[5%] py-16 md:py-24 lg:py-28">
            <div class="container mx-auto">
                <div class="grid grid-cols-1 items-center gap-12 md:grid-cols-2 lg:gap-x-20">
                    ...
                    <div class="order-1 md:order-2">
                        <div class="grid grid-cols-1 gap-x-6 gap-y-8 py-2">
                            <?php if (have_rows('cards')) : ?>
                                <?php while (have_rows('cards')) : the_row(); 
                                    $icon = get_sub_field('icon');
                                    $title = get_sub_field('title');
                                ...
                                ?>
                                    <div class="flex self-start">
                                        <div class="mr-6 flex-none self-start">
                                            <?php if ($icon) : ?>
                                                <?php echo $icon; ?>
                                            <?php else : ?>
                                        ...
                                        <div>
                                            <h3 class="mb-3 text-xl font-bold md:mb-4 md:text-2xl">
                                                <?php echo $title ? esc_html($title) : 'Feature Title'; ?>
                                            </h3>
                                            <p>
                                                <?php echo $content ? esc_html($content) : 'Feature description text goes here.'; ?>
                                            </p>
                                            <div class="mt-5 flex items-center gap-x-4 md:mt-6">
                                                <a href="<?php echo $button_link ? esc_url($button_link) : '#'; ?>" class="inline-flex items-center justify-center font-semibold text-[#269763] hover:text-[#1c7049]">
                                                    <?php echo $button_label ? esc_html($button_label) : 'Learn More'; ?>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right ml-1"><path d="m9 18 6-6-6-6"/></svg>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <?php else : ?>
                                ...
                                <div class="flex self-start">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Discover the essential tools and valuable insights that will take your game to the next level and significantly improve your overall tournament experience. Elevate your skills and enjoy every moment!
                                        </p>
                                        <div class="mt-5 flex items-center gap-x-4 md:mt-6">
                                            <a href="#" class="inline-flex items-center justify-center font-semibold text-[#269763] hover:text-[#1c7049]">
                                                Learn More
                                ...
                                <div class="flex self-start">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Come and participate in our exhilarating tournaments and engaging events, specifically crafted for players of every skill level, whether you're a beginner or a seasoned pro. Excitement awaits you!
                                        </p>
                                        <div class="mt-5 flex items-center gap-x-4 md:mt-6">
                                            <a href="#" class="inline-flex items-center justify-center font-semibold text-[#269763] hover:text-[#1c7049]">
                                                Sign Up
                                ...
                                <div class="flex self-start">
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            Join a lively community of fellow golf enthusiasts where you can connect, share experiences, and deepen your passion for the game. Engage with others who love golf just as much as you do!
                                        </p>
                                        <div class="mt-5 flex items-center gap-x-4 md:mt-6">
                                            <a href="#" class="inline-flex items-center justify-center font-semibold text-[#269763] hover:text-[#1c7049]">
                                                Join Now
