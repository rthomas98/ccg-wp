...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php
    // Layout437 Component
    if (have_rows('header_437')) :
        while (have_rows('header_437')) : the_row();
            $sub_header = get_sub_field('sub_header') ?: 'Join us for an exciting and enriching experience!';
            $header = get_sub_field('header') ?: 'Unlock Exclusive Benefits with Our Membership';
            $content = get_sub_field('content') ?: 'Become a part of the Chau Chau Golf community and elevate your game. Enjoy access to exclusive tournaments, resources, and networking opportunities tailored for golf enthusiasts.';
            $images = get_sub_field('images');
            $image_two = get_sub_field('image_two');
    ?>
        <section id="layout437" class="px-[5%] py-16 md:py-24 lg:py-28">
            <div class="container mx-auto">
                <div class="grid grid-cols-1 items-start gap-x-16 gap-y-12 md:grid-cols-[1fr_0.5fr]">
                    <div class="order-last flex flex-col justify-center md:order-first">
                        <div class="grid grid-cols-[0.75fr_1fr] gap-6 sm:gap-8">
                            <?php if ($images) : ?>
                                <img src="<?php echo esc_url($images['url']); ?>" alt="<?php echo esc_attr($images['alt']); ?>" class="aspect-square w-full object-cover" />
                            <?php else : ?>
                                <img src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-landscape.svg" class="aspect-square w-full object-cover" alt="Relume placeholder image 2" />
                            <?php endif; ?>
                            <?php if ($image_two) : ?>
                                <img src="<?php echo esc_url($image_two['url']); ?>" alt="<?php echo esc_attr($image_two['alt']); ?>" class="aspect-[2/3] w-full object-cover" />
                            <?php else : ?>
                                <img src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image.svg" class="aspect-[2/3] w-full object-cover" alt="Relume placeholder image 1" />
                            <?php endif; ?>
                        </div>
                    </div>
                            ...
                            <div class="mt-6 flex flex-wrap gap-4 md:mt-8">
                                <?php if (have_rows('buttons')) : ?>
                                    <?php while (have_rows('buttons')) : the_row(); 
                                        $button_one_label = get_sub_field('button_one_label') ?: 'Sign Up';
    ...
    <?php if (have_rows('layout_192')) : ?>
        <?php while (have_rows('layout_192')) : the_row(); ?>
            <section id="layout192" class="px-[5%] py-16 md:py-24 lg:py-28">
                <div class="container mx-auto">
                                    ...
                                    ?>
                                        ...
                                        <?php if ($button_two_link) : ?>
                                            <a href="<?php echo esc_url($button_two_link); ?>" 
                                               class="inline-flex items-center justify-center gap-2 text-[#269763] hover:underline">
