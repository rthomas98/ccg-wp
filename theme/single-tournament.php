                    ...
                    <?php while (have_rows('additional_information')) : the_row(); ?>
                        <?php if (have_rows('contact_information')) : ?>
                            <?php while (have_rows('contact_information')) : the_row(); ?>
                                <div class="rounded-xl border border-gray-100 bg-gray-50 p-8 transition-transform hover:shadow-md">
                                    <div class="mb-4 inline-flex rounded-lg bg-[#269763]/10 p-3">
                                        <i data-lucide="phone" class="h-6 w-6 text-[#269763]"></i>
                                    </div>
                                    <h3 class="mb-3 text-xl font-bold">Contact</h3>
                                    <ul class="space-y-2 text-gray-600">
                                        <?php if (get_sub_field('contact_name')) : ?>
                                            <li class="flex items-start gap-2">
                                                <i data-lucide="user" class="mt-1 h-4 w-4 text-[#269763]"></i>
                                                <span><?php echo esc_html(get_sub_field('contact_name')); ?></span>
                                            </li>
                                        <?php endif; ?>
                                        <?php if (get_sub_field('contact_email')) : ?>
                                            <li class="flex items-start gap-2">
                                                <i data-lucide="mail" class="mt-1 h-4 w-4 text-[#269763]"></i>
                                        ...
                                        <?php if (get_sub_field('contact_phone')) : ?>
                                            <li class="flex items-start gap-2">
                                                <i data-lucide="phone" class="mt-1 h-4 w-4 text-[#269763]"></i>
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-1 gap-16">
                ...
                <div class="w-full">
                    <!-- Contact Information -->
                    <?php 
                    // Check if contact information has data before displaying the section
                    ...
                    <?php if (have_rows('registration_info')) : ?>
                        <?php while (have_rows('registration_info')) : the_row(); ?>
                            <div class="mt-8 rounded-lg bg-gray-50 p-8">
                                ...
                                if (have_rows('whats_included')) {
                                    while (have_rows('whats_included')) {
                                        the_row();
                                        if (get_sub_field('item')) {
                                            $has_whats_included = true;
                                            break;
                                        }
                                    }
                                    reset_rows(); // Reset for display
